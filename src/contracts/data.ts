...
export type AssessmentType = 'quiz' | 'code_challenge' | 'presentation' | 'assignment';
...
export interface ArtefactSeed { type: ArtefactType; skeleton: string; }
export interface Provenance { origin: 'generated' | 'practitioner' | 'hybrid'; contributorIds: string[]; }
export interface QualitySignal { kind: 'approved' | 'edited' | 'rejected' | 'regenerated'; weight: number; }
