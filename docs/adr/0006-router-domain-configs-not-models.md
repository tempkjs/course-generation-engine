...
*models* — a training/ops appliance we don't need and which fragments the multi-field thesis.
...
*configurations*. The router is a dispatch function behind Seam 1 — no new seam. It composes
